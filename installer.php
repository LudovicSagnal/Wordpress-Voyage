...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'Ludo_voyage_117531ef269b910f7075_20230104133814_archive.zip';
        const ARCHIVE_SIZE       = '61589609';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '117531e-04133814';
        const SECONDARY_PACKAGE_HASH = '5e2ecf3-04133814';
        const VERSION            = '1.5.1';
